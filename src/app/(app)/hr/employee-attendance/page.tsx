    ...
    return (
        <div className="grid gap-6 lg:grid-cols-5">
            <div className="lg:col-span-3 space-y-6">
                <Card>
                    <CardHeader>
                        <CardTitle>Employee Attendance Log</CardTitle>
                        <CardDescription>Review employee attendance records.</CardDescription>
                    </CardHeader>
                    <CardContent>
                         <Table>
                            <TableHeader>
            ...
            <div className="lg:col-span-2">
                 <Card>
                    <CardHeader>
                        ...
                        <CardDescription>View team attendance and leave.</CardDescription>
                    </CardHeader>
